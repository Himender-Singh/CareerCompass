...
const LeftNavbar = () => {
  ...
  const logoutHandler = async () => {
    try {
      const res = await axios.get('https://careercompass-1-sq77.onrender.com/api/v1/user/logout', {
  ...
  return (
    <>
      ...
      <div
        className={`fixed overflow-y-auto top-0 left-0 h-screen w-80 bg-[#080101] p-5 font-poppins text-white shadow-md shadow-gray-800/10 z-40 transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full'
