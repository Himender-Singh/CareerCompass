...
const Craousal = () => {
    ...
    animate: {
      ...
      transition: {
        x: {
          repeat: Infinity,
          repeatType: "loop",
          duration: 30, // Time to move across the entire width
          ease: "linear",
        },
  ...
  return (
    <div className="w-full bg-[#0f172a] h-auto py-20 text-white">
      {/* Heading */}
      ...
      <div className="overflow-hidden container mx-auto">
        ...
        >
          {[...cards, ...cards].map((card, index) => (
            <motion.div
              key={index}
              className="min-w-[400px] p-6 bg-[#1e293b] rounded-lg text-center shadow-lg flex items-center space-x-4"
            >
