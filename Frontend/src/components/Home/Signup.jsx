...
const Signup = () => {
  ...
  const signupHandler = async (e) => {
    ...
    try {
      const res = await axios.post(
        "https://careercompass-1-sq77.onrender.com/api/v1/user/register",
        input,
        {
          headers: {
  ...
  return (
    <div className="flex items-center justify-center w-full mt-10 h-screen bg-[#0f172a]">
      <div className="flex flex-col items-center justify-center w-full max-w-md p-10 bg-[#1e293b] shadow-lg rounded-lg">
        <div className="flex items-center justify-center mb-4">
          {/* Logo */}
          <img src={img} alt="Logo" className="w-52" />
        </div>
